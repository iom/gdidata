...
#' is not possible to establish the precise number of persons who have illegally
#' crossed the external border.
#'
#' Mentions of Kosovo are in the context of UN Security Council Resolution 1244.
#'
